...
smd({
  ...
  try {
    let _0x365550 = "┏━━━━━━━━━━━━━━━━━━━━━━━━\n┃\t*Legend-MD-𝐅𝐀𝐍𝐂𝐘-𝐓𝐄𝐗𝐓💬* \n┗━━━━━━━━━━━━━━━━━━━━━━━━\n\n " + (_0x3b568a ? "```🔢Reply the number you wants to select``` \n\n" : "```\t\t" + prefix + "fancy Legend(For all text)\n\t\t" + prefix + "fancy 25 Legend(For specific text)```\n\n");
...
smd({
  ...
  try {
    ...
    if (!_0xd51ec) {
      return _0x4cfc4e.reply("*_Example : " + prefix + "fliptext Legend MD!_*");
    }
...
smd({
  ...
  try {
    ...
    if (_0x2cee76) {
      ...
      return _0x54e3dc.reply("*_Hey, provide text, ex .ttp 4 hii im Legend!!_*");
    }
  } catch (_0x72e5d) {
