...
smd({
  ...
  try {
    try {
      ...
      const _0x50c8d3 = await fetch("https://widipe.com/openai?text=" + _0x557719);
...
smd({
  ...
  try {
    ...
    const _0x4c275e = await fetch("https://widipe.com/openai?text=" + _0x1b0897);
...
smd({
  ...
  try {
    ...
    let _0x5d0b6a = false;
    try {
      const _0x37057d = await fetch("https://widipe.com/openai?text=" + (_0x5e79d4 + " \nNOTE: Make sure to looks like imagination, make it short and concise, also in english!"));
...
smd({
  ...
  try {
    let {
      data: _0x44f98c
    } = await axios.get("https://api.github.com/HsnCyber/LEGEND-X-HM");
    let _0x1c73f9 = ("\nLEGEND-X-HM created by Hassan fully featured bot*" + Config.ownername + "*.\n\n  *Stars:* " + (_0x44f98c?.stargazers_count || "Unkown") + " stars\n  *Forks:* " + (_0x44f98c?.forks_count || "Unkown") + " forks\n  *Authors:* Hassan\n  *Created On:* " + (_0x44f98c?.created_at || "undefined") + "\n  *Repo:* _https://github.com/HsnCyber/LEGEND-X-HM_\n  *Scan:* _" + scan + "_" + (Config.caption ? "\n\n" + Config.caption : "")).trim();
...
smd({
  ...
  try {
    ...
    if (_0x48975a[0]) {
      ...
      _0x5f656f = "*LEGEND-MD• ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ*\n\n*Msg_Id:* " + _0x3079e2.id + "\n*Date:* _" + _0xbcd286 + "_\n*Time:* _" + _0x47ad13 + "_\n\n*Message:* " + _0x5f656f + "\n\n\n" + Config.caption;
...
smd({
  ...
  try {
    if (_0x2acf30.quoted && isAnnonyMsgAlive.includes(_0x2acf30.sender) && _0x2acf30.text.length > 2) {
      ...
      if (_0x2acf30.reply_text.includes("LEGEND-MD• ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") && _0x2dfb59[0].includes("LEGEND-MD• ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") && _0x2dfb59[2].includes("Msg_Id")) {
